            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>This reference architecture shows how to apply neural style transfer to a video, using Azure Batch AI.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Batch scoring of Python models on Azure</h3>
                        <p>Build a scalable solution for batch scoring models on a schedule in parallel using Azure Batch AI.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Build a Real-time Recommendation API on Azure</h3>
                        <p>Use machine learning to automate recommendations using Azure Databricks and Azure Data Science Virtual Machines (DSVM) to train a model on Azure.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>This reference architecture shows how to deploy Python models as web services on Azure to make real-time predictions.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Implement a real-time prediction service in R using Machine Learning Server running in Azure Kubernetes Service (AKS).</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Highly available multi-region web application</h3>
                        <p>Recommended architecture for a highly available web application running in multiple regions in Azure.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Improve scalability in a web application running in Microsoft Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Automated enterprise business intelligence (BI)</h3>
                        <p>Automate an extract, load, and transform (ELT) workflow in Azure using Azure Data Factory with SQL Data Warehouse.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Use Azure to gain business insights from relational data stored on-premises.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Create an end-to-end stream processing pipeline in Azure using Azure Databricks.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Create an end-to-end stream processing pipeline in Azure.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Deploy network virtual appliances with high availability.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Implement a DMZ between Azure and the Internet</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Implement a secure hybrid network architecture</h3>
                        <p>Implement a secure hybrid network architecture in Azure.</p>
                    </div>
                </div>
            </div>
        </div>
...
<ul  class="panelContent cardsC">
<li style="display: flex; flex-direction: column;">
    <a href="./enterprise-integration/basic-enterprise-integration.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
...
<li style="display: flex; flex-direction: column;">
    <a href="./enterprise-integration/queues-events.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Enterprise integration using message queues and events</h3>
                        <p>Recommended architecture for implementing an enterprise integration pattern with Azure Logic Apps, Azure API Management, Azure Service Bus, and Azure Event Grid.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Implement a secure site-to-site network architecture that spans an</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Implement a hub-spoke network topology with shared services in Azure.</p>
                    </div>
                </div>
            </div>
        </div>
...
<li style="display: flex; flex-direction: column;">
    <a href="./hybrid-networking/troubleshoot-vpn.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Troubleshoot a hybrid VPN connection</h3>
                        <p>Troubleshoot a VPN gateway connection betweeen an on-premises network and Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Connect an on-premises network to Azure using VPN</h3>
                        <p>Implement a secure site-to-site network architecture that spans an Azure virtual network and an on-premises network connected using a VPN.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Extend your on-premises Active Directory domain to Azure</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Extend on-premises AD FS to Azure</h3>
                        <p>Implement a secure hybrid network architecture with Active Directory Federation Service authorization in Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./microservices/" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>Microservices architecture on Azure Kubernetes Service (AKS)</h3>
                        <p>Deploy a microservices architecture on Azure Kubernetes Service (AKS)</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Run a Linux VM on Azure</h3>
                        <p>Best practices for running a Linux virtual machine on Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Multi-region N-tier application for high availability</h3>
                        <p>Deploy an application on Azure virtual machines in multiple regions for high availability and resiliency.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>N-tier application with Apache Cassandra</h3>
                        <p>Run Linux virtual machines for an N-tier architecture with Apache Cassandra in Microsoft Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Windows N-tier application with SQL Server</h3>
                        <p>Implement a multi-tier architecture on Azure for availability, security, scalability, and manageability.</p>
                    </div>
                </div>
            </div>
        </div>
...
<li style="display: flex; flex-direction: column;">
    <a href="./n-tier/windows-vm.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Run a Windows VM on Azure</h3>
                        <p>Best practices for running a Windows virtual machine on Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Deploy SAP NetWeaver (Windows) for AnyDB on Azure VMs</h3>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Recommended architecture for a serverless web application and web API.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./sharepoint/" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
